...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('stok_pakan')->name('stok_pakan.')->group(function() {
        Route::get('/', [App\Http\Controllers\ManajemenTambak\StokPakanController::class, 'index'])->name('index');
        Route::get('/data', [App\Http\Controllers\ManajemenTambak\StokPakanController::class, 'data'])->name('data');
        Route::post('/store', [App\Http\Controllers\ManajemenTambak\StokPakanController::class, 'store'])->name('store');
        Route::get('/show/{uuid}', [App\Http\Controllers\ManajemenTambak\StokPakanController::class, 'show'])->name('show');
        Route::post('/update/{uuid}', [App\Http\Controllers\ManajemenTambak\StokPakanController::class, 'update'])->name('update');
        Route::delete('/delete/{uuid}', [App\Http\Controllers\ManajemenTambak\StokPakanController::class, 'destroy'])->name('delete');
    });
});