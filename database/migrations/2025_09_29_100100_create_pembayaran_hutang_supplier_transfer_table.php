...
return new class extends Migration
{
    ...
    {
        Schema::create('pembayaran_hutang_supplier_transfer', function (Blueprint $table) {
            $table->id('id_pembayaran_hutang_supplier_transfer');
    ...
    {
        Schema::dropIfExists('pembayaran_hutang_supplier_transfer');
    }
};
