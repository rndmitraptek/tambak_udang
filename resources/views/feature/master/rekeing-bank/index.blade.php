...
@endsection
@section('ctrl')
@include('feature.master.rekeing-bank.script')
@endsection
            ...
            <form id="formInput">
                ...
                <div class="modal-body">
                    <div class="form-group m-form__group">
                        ...
                        <input type="text" class="form-control" name="no_rekening" ng-model="input.no_rekening">
                    </div>
                    <div class="form-group m-form__group">
                        <label for="recipient-name" class="form-control-label">Bank</label>
                        <input type="text" class="form-control" name="nama_bank" ng-model="input.nama_bank">
                    </div>
                    <div class="form-group m-form__group">
