...
@endsection
@section('ctrl')
@include('feature.master.payment-method.script')
@endsection
        ...
        <div class="modal-content">
            <form id="formInput">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Paymnet Method</h5>
                ...
                <div class="modal-body">
                    <div class="form-group m-form__group">
                        <label for="recipient-name" class="form-control-label">Nama Payment Method</label>
                        <input type="text" class="form-control" name="payment_method" ng-model="input.payment_method">
                    </div>
                </div>
