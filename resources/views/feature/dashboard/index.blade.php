...
@endsection
@section('ctrl')
@include('feature.dashboard.script')
@endsection
        ...
        <div class="col-lg-6" ng-repeat="i in siklus">
            <div class="m-portlet m-portlet--tab">
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <h3 class="m-portlet__head-text">
                                <% i.lokasi.nama_lokasi %>, <% i.nama_siklus %>
                            </h3>
                        </div>
                    </div>
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                                <a href="/dashboard_petak/<% i.uuid %>" class="btn m-btn m-btn--gradient-from-focus m-btn--gradient-to-danger">
                                    <span>
                ...
                <div class="m-portlet__body">
                    <canvas id="myChart_<% i.uuid %>"></canvas>
                </div>
            </div>
        </div>
    </div>
