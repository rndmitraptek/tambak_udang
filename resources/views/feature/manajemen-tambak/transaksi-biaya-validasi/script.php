        ...
        $("#viewtabel").DataTable({
                ...
                columnDefs: [{
                    ...
                    render: function(a, e, t, n) {
                        return `<a class="checklist m-portlet__nav-link btn m-btn m-btn--hover-warning m-btn--icon m-btn--icon-only m-btn--pill" title="View"><i class="la la-list-alt"></i></a>`
                    }
                }],
            })
        // }, 500);
